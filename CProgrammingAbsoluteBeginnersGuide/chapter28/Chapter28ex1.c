...
// to C, 3rd Edition
// File Chapter28ex1.c
/* The program takes the book info program from chapter 27 and writes the info to
...
// Remember when typing your filename path to double up the // backslashes or C will think you are putting in a conversion // character
    fptr = fopen("C:\\IanQian\\c\\projects\\cLearning\\CProgrammingAbsoluteBeginnersGuide\\chapter28\\BookInfo.txt", "w"); // Test to ensure that the file opened
    if (fptr == 0) {
