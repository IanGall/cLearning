 ...
 * ID against a list of customers in the database. If the customer exists,
 * it uses that array element to check their current balance,
...
int main() {
    ...
    bubbleSortIntWithFloat(0, 0, 0, 0, custID, custBal);
