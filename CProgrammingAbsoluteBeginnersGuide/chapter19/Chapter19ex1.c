 ...
 * It tests whether their password has an uppercase letter, lowercase letter,
 * and a digit. If it does, the program congratulates their selection.
 * If not, it suggests they might want to consider a password with more variety
...
int main() {
    ...
    /*This loop goes through each character of the password and test
