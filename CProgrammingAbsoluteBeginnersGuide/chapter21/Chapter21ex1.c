 ...
 * The scores form the first six games are in the program and the scores
 * from the last four are inputted by the user.*/
#include <stdio.h>

int main(){
    int gameScores[10] = {12, 15, 21, 15, 32, 10};
    int totalPoints = 0;
    int i;
    float avg;
    ...
    for ( i = 6; i < 10; ++i) {
         ...
         * of the first game as game0, but game 1*/
    ...
    /*User a floating-point variable for the average as it is
